    ...
    <div class="card card-warning">
      ...
      <div class="card-body">
        <table id="example1" class="table table-sm table-bordered table-striped" style="font-size: 13px; text-align: center;">
          <thead>
            <tr>
              <th colspan="16" valign="middle" style="text-align: center">Masuk</th>
           ...
           $sqlDB21 = " SELECT
            ...
            ?>
              <tr>
                ...
                <td style="text-align: center"><?php if (substr($rowdb21['EXTERNALREFERENCE'], 0, 3) == "000" or substr($rowdb21['EXTERNALREFERENCE'], 0, 2) == "00") {
                                                  echo $rowdb21['EXTERNALREFERENCE'];
                                                } ?></td>
                ...
                <td style="text-align: center"><?php if ($rowdb23['SCHEDULEDRESOURCECODE'] != "") {
                                                  echo $rowdb23['SCHEDULEDRESOURCECODE'];
                                                } else {
                                                  echo $rowdb25['NO_MESIN'];
                                                } ?></td>
                <td style="text-align: center"><?php if (substr($rowdb21['EXTERNALREFERENCE'], 0, 2) == "00" or substr($rowdb21['EXTERNALREFERENCE'], 0, 3) == "000") {
                                                } else {
                                                  echo $rowdb21['EXTERNALREFERENCE'];
                                                } ?></td>
                ...
                <td style="text-align: left"><span style="text-align: center">
                    <?php if ($rowdb26['GSM1'] != "") {
                      echo round($rowdb26['GSM1']);
                    } else if ($rowdb27['GSM1'] != "") {
                      echo round($rowdb27['GSM1']);
                    } else {
                      echo round($rowdb30['GSM1']);
                    } ?>
                  </span></td>
          ...
          <div class="card-body">
            <table id="example3" class="table table-sm table-bordered table-striped" style="font-size: 13px; text-align: center;">
              ...
              FROM
                ...
                SELECT
                  s.TRANSACTIONNUMBER,
                  a1.VALUESTRING AS KET 
                FROM
                  STOCKTRANSACTION s
                  LEFT OUTER JOIN ADSTORAGE a ON a.UNIQUEID = s.ABSUNIQUEID 
                  AND a.NAMENAME = 'StatusRetur'
                  LEFT OUTER JOIN ADSTORAGE a1 ON a1.UNIQUEID = s.ABSUNIQUEID 
                  AND a1.NAMENAME = 'KainSudahProses' 
                WHERE
                  s.PROJECTCODE = '$Project' 
                  AND s.ITEMTYPECODE = 'KGF' 
                  AND s.DECOSUBCODE02 = '$subC1' 
                ...
                GROUP BY
                  ...
                  s.TRANSACTIONNUMBER,
                a1.VALUESTRING 
                ) ac ON ab.TRANSACTIONNUMBER = ac.TRANSACTIONNUMBER";
                /*$sqlDB21R = " SELECT 
s.TRANSACTIONDATE,s.DECOSUBCODE02,s.DECOSUBCODE03,s.DECOSUBCODE04,
s.LOTCODE,SUM(s.BASEPRIMARYQUANTITY) AS KG,COUNT(s.ITEMELEMENTCODE) AS JML  FROM STOCKTRANSACTION s 
LEFT OUTER JOIN ADSTORAGE a ON a.UNIQUEID = s.ABSUNIQUEID AND a.NAMENAME = 'StatusRetur'
WHERE s.PROJECTCODE='$Project' AND s.ITEMTYPECODE='KGF' AND 
s.DECOSUBCODE02='$subC1' AND s.DECOSUBCODE03='$subC2' AND 
...
s.ITEMELEMENTCODE
		...
		GROUP BY BALANCE.LOTCODE ";	*/
          $sqlDB22R = "SELECT
                  ...
                  if ($rowdb21R['KET'] == "1") {
                    $ketR = "SCO1-PRE1-SUE1-RSE1";
                  } else if ($rowdb21R['KET'] == "2") {
                    $ketR = "SCO1-PRE1";
                  } else if ($rowdb21R['KET'] == "3") {
                    $ketR = "RLX1-OVN1-PRE1";
                  } else if ($rowdb21R['KET'] == "4") {
                    $ketR = "RLX1-PRE1-RSE1";
                  } else if ($rowdb21R['KET'] == "5") {
                    $ketR = "PRE1-STM1";
                  } else if ($rowdb21R['KET'] == "5") {
                    $ketR = "BAT2-PRE1";
                  } else {
                ...
                ?>
                  <tr>
                    ...
                    <td style="text-align: left"><span style="text-align: center">
                        <?php if ($rowdb26R['LEBAR1'] != "") {
                          echo round($rowdb26R['LEBAR1']);
                        } else {
                          echo round($rowdb27R['LEBAR1']);
                        } ?>
                      </span></td>
                    <td style="text-align: left"><span style="text-align: center">
                        <?php if ($rowdb26R['GSM1'] != "") {
                          echo round($rowdb26R['GSM1']);
                        } else {
                          echo round($rowdb27R['GSM1']);
                        } ?>
                      </span></td>
                    ...
                    <td style="text-align: right"><?php echo $ketR; ?></td>
