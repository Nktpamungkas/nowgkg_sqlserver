		 ...
		 <form role="form" method="post" enctype="multipart/form-data" name="form1"> 
          ...
          <div class="card-body">
             <div class="form-group row">
               ...
               <div class="col-md-3">  
                 <input type="text" class="form-control form-control-sm" value="<?php echo $Project; ?>" name="projectcode">
			   </div>	
            </div>
			 <div class="form-group row">
                    <label for="hangerno" class="col-md-1">No. Hanger</label>
					<div class="col-md-3">  
                 <input type="text" class="form-control form-control-sm" value="<?php echo $HangerNO; ?>" name="hangerno">
			   </div>	
                  </div>
...
$no=1;   
$c=0;
if($Project!=""){$WProj=" AND (b.PROJECTCODE='$Project' OR prj.PROJECTCODE='$Project' OR prj1.PROJECTCODE='$Project') ";}else{$WProj=" ";}
if($HangerNO!=""){$Whanger=" AND CONCAT(trim(b.DECOSUBCODE02),trim(b.DECOSUBCODE03))='$HangerNO' ";}else{$Whanger=" ";}	
$sqlDB21 = " SELECT SUM(b.BASEPRIMARYQUANTITYUNIT) AS BERAT, SUM(b.BASESECONDARYQUANTITYUNIT) AS YD, COUNT(b.BASESECONDARYQUANTITYUNIT) AS ROLL,b.PROJECTCODE,
...
b.BASEPRIMARYUNITCODE,b.BASESECONDARYUNITCODE,prj.PROJECTCODE AS PROJAWAL,prj1.PROJECTCODE AS PROJAWAL1,
prj2.PRODUCTIONORDERCODE,prj2.ORIGDLVSALORDLINESALORDERCODE
FROM BALANCE b 
LEFT OUTER JOIN (
SELECT
...
b.DECOSUBCODE08,b.PROJECTCODE,
b.BASEPRIMARYUNITCODE,b.BASESECONDARYUNITCODE,
prj.PROJECTCODE,prj1.PROJECTCODE,prj2.PRODUCTIONORDERCODE,prj2.ORIGDLVSALORDLINESALORDERCODE ";
