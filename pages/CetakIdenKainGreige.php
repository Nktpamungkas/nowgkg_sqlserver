  ...
  INTERNALDOCUMENTLINE.INTERNALREFERENCEDATE ";
              ...
              ?>
                <tr>
                  ...
                  <td style="text-align: center"><a href="pages/cetak/iden-greige-now.php?intdoc=<?php echo trim($rowdb2['INTDOCUMENTPROVISIONALCODE']); ?>&orderline=<?php echo trim($rowdb2['ORDERLINE']); ?>" class="btn btn-primary btn-xs" target="_blank"><i class="fa fa-print" data-toggle="tooltip" data-placement="top" title="Cetak"></i> </a></td>
                </tr>
