    ...
    INTERNALDOCUMENT.PROVISIONALCODE ";
              ...
              while ($rowdb21 = db2_fetch_assoc($stmt1)) {
                ...
                if ($rowdb22['ORDERPARTNERBRANDCODE'] == "") {
                  ...
                  $buyer = $rowdb22['ORDERPARTNERBRANDCODE'];
                }
                if ($rowdb21['QTY_KG'] > 0) {
                  $qtyB = $rowdb21['QTY_KG'];
                } else {
                  $qtyB = $rowdb21['QTY1_KG'];
                }
              ...
              ?>
                <tr>
                  ...
                  <td style="text-align: left"><span style="text-align: center"><?php if ($rowdb21['SCHEDULEDRESOURCECODE'] != "") {
                                                                                  echo $rowdb21['SCHEDULEDRESOURCECODE'];
                                                                                } else {
                                                                                  echo $rowdb27['NO_MESIN'];
                                                                                } ?></span></td>
                  <td style="text-align: center"><?php if (substr($rowdb21['EXTERNALREFERENCE'], 0, 3) != "000" or substr($rowdb21['EXTERNALREFERENCE'], 0, 2) != "00") {
                                                    echo $rowdb21['EXTERNALREFERENCE'];
                                                  } ?></td>
                  <td style="text-align: left"><span style="text-align: center">
                      <?php if ($rowdb25['LEBAR1'] != "") {
                        echo round($rowdb25['LEBAR1']);
                      } else if ($rowdb26['LEBAR1'] != "") {
                  ...
                  <td style="text-align: left"><span style="text-align: center">
                      <?php if ($rowdb25['GSM1'] != "") {
                        echo round($rowdb25['GSM1']);
                      } else if ($rowdb26['GSM1'] != "") {
...
p.ITEMTYPECODE ='KFF'  ";
                ...
                if ($rowdb22R1['LEGALNAME1'] == "") {
                  ...
                  $langganan = $rowdb22R1['LEGALNAME1'];
                }
                if ($rowdb22R1['ORDERPARTNERBRANDCODE'] == "") {
                  $buyer = "";
                } else {
                  $buyer = $rowdb22R1['ORDERPARTNERBRANDCODE'];
                }
              ?>
                <tr>
                  <td style="text-align: center"><?php echo $no; ?></td>
                  ...
                  <td style="text-align: center"><?php if ($rowdb21R['ALURPROSES'] == "1") {
                                                    echo "Steam-Preset";
                                                  } else if ($rowdb21R['ALURPROSES'] == "2") {
                                                    echo "Relaxing-Preset";
                                                  } ?></td>
                  <td style="text-align: center"><?php echo $rowdb21R['NOMESIN']; ?></td>
                  <td style="text-align: center"><?php //echo round($rowdb26R['LEBAR1']); 
                                                  ?></td>
                  <td style="text-align: center"><?php //echo round($rowdb26R['GSM1']); 
                                                  ?></td>
...
p.ITEMTYPECODE ='KFF'  ";
                ...
                if ($rowdb22R1BU['LEGALNAME1'] == "") {
                  ...
                  $langgananBU = $rowdb22R1BU['LEGALNAME1'];
                }
                if ($rowdb22R1BU['ORDERPARTNERBRANDCODE'] == "") {
                  $buyerBU = "";
                } else {
                  $buyerBU = $rowdb22R1BU['ORDERPARTNERBRANDCODE'];
                }
              ?>
                <tr>
                  <td style="text-align: center"><?php echo $no; ?></td>
                  ...
                  <td style="text-align: center"><?php if ($rowdb21RBU['ALURPROSES'] == "1") {
                                                    echo "Steam-Preset";
                                                  } else if ($rowdb21RBU['ALURPROSES'] == "2") {
                                                    echo "Relaxing-Preset";
                                                  } ?></td>
            ...
            <tbody>
              ...
              while ($rowdb21A = db2_fetch_assoc($stmt1A)) {
                ...
                if ($rowdb22A1['LEGALNAME1'] == "") {
                  ...
                  $langgananA = $rowdb22A1['LEGALNAME1'];
                }
                if ($rowdb22A1['ORDERPARTNERBRANDCODE'] == "") {
                  $buyerA = "";
                } else {
                  $buyerA = $rowdb22A1['ORDERPARTNERBRANDCODE'];
                }
              ?>
                <tr>
                  <td style="text-align: center"><?php echo $no; ?></td>
          ...
          <table id="example7" width="100%" class="table table-sm table-bordered table-striped" style="font-size: 11px; text-align: center;">
            ...
            <tbody>
              ...
              while ($rowdb21AN = db2_fetch_assoc($stmt1AN)) {
                ...
                if ($rowdb21AN['PROJECTCODE'] != "") {
                  $proj = $rowdb21AN['PROJECTCODE'];
                } else {
                  $proj = $rowdb21AN['ORIGDLVSALORDLINESALORDERCODE'];
                }
                ...
                if ($rowdb22A1N['LEGALNAME1'] == "") {
                  ...
                  $langgananAN = $rowdb22A1N['LEGALNAME1'];
                }
                if ($rowdb22A1N['ORDERPARTNERBRANDCODE'] == "") {
                  $buyerAN = "";
                } else {
                  $buyerAN = $rowdb22A1N['ORDERPARTNERBRANDCODE'];
                }
              ?>
                <tr>
                  <td style="text-align: center"><?php echo $no; ?></td>
