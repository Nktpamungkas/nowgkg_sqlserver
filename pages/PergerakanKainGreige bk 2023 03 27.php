...
SELECT 
STKKELUAR.ITEMELEMENTCODE,STKKELUAR.BASEPRIMARYQUANTITY,STKKELUAR.CREATIONUSER,  
       STKKELUAR.TRANSACTIONDATE,STKKELUAR.ORDERCODE,STKKELUAR.PROJECTCODE,ITXVIEWLAPMASUKGREIGE.PROVISIONALCODE, 
...
WHERE (PROJECTCODE ='$rowdb23[PROJECTCODE]' OR PROJECTCODE ='$prjct') AND ITEMTYPE_DEMAND ='$rowdbWRN[ITEMTYPEAFICODE]' AND 
