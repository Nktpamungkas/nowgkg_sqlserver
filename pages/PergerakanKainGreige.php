...
$sqlDB210 = " SELECT
			...
			WHERE
				...
				AND (
					a.PROJECTCODE = '$Project'
					OR a.ORIGDLVSALORDLINESALORDERCODE = '$Project'
				)
				AND a.SUBCODE02 = '$subC1'
						...
						<table id="example1" class="table table-sm table-bordered table-striped" style="font-size: 13px; text-align: center;">
							...
							<tbody>
								...
								$sqlDB21 = "SELECT
												...
												ITXVIEWLAPMASUKGREIGE.SUBCODE02,
												ITXVIEWLAPMASUKGREIGE.SUBCODE03,
												ITXVIEWLAPMASUKGREIGE.SUBCODE04,
												ITXVIEWLAPMASUKGREIGE.ORDERLINE,
												ITXVIEWLAPMASUKGREIGE.EXTERNALREFERENCE,
												ITXVIEWLAPMASUKGREIGE.INTERNALREFERENCE,
												ITXVIEWLAPMASUKGREIGE.ITEMDESCRIPTION,
												ITXVIEWLAPMASUKGREIGE.LOTCODE,
												...
												ITXVIEWLAPMASUKGREIGE.WAREHOUSELOCATIONCODE,
												ITXVIEWLAPMASUKGREIGE.DESTINATIONWAREHOUSECODE,
												ITXVIEWLAPMASUKGREIGE.SUMMARIZEDDESCRIPTION,
												ITXVIEWLAPMASUKGREIGE.PROVISIONALCODE,
											...
											WHERE
												STOCKTRANSACTION.PROJECTCODE = '$Project'
								...
								while ($rowdb21 = db2_fetch_assoc($stmt1)) {
									...
									$sqlDB22 = "SELECT
												...
												WHERE
													...
													AND STOCKTRANSACTION.ORDERCODE = '$rowdb21[PROVISIONALCODE]'
									...
									$sqlDBMC = " SELECT
														ad.VALUESTRING AS MESIN
													FROM
														PRODUCTIONDEMAND pd
														LEFT OUTER JOIN ADSTORAGE ad ON ad.UNIQUEID = pd.ABSUNIQUEID
														AND ad.NAMENAME = 'MachineNo'
													WHERE
														CODE = '$rowdb21[LOTCODE]'
															";
							...
							<tbody>
								...
								$sqlDB21RP = " SELECT
												...
												FROM
													(
														SELECT
															STKKELUAR.ITEMELEMENTCODE,
															STKKELUAR.BASEPRIMARYQUANTITY,
															STKKELUAR.CREATIONUSER,
														...
														FROM
															...
															INNER JOIN (
																...
																WHERE
																	...
																	AND STOCKTRANSACTION.LOGICALWAREHOUSECODE = 'M021'
																	AND TEMPLATECODE = '125'
															) AS STKKELUAR ON STKKELUAR.ITEMELEMENTCODE = STOCKTRANSACTION.ITEMELEMENTCODE
														WHERE
															STOCKTRANSACTION.PROJECTCODE = '$Project'
															AND DECOSUBCODE02 = '$subC1'
															AND DECOSUBCODE03 = '$subC2'
						...
						<table id="example8" class="table table-sm table-bordered table-striped" style="font-size: 13px; text-align: center;">
							<thead>
								<tr>
									...
									<th colspan="2" valign="middle" style="text-align: center">Masuk</th>
							...
							<tbody>
								...
								$sqlDB21R = " SELECT
												...
												WHERE
													s.PROJECTCODE = '$Project'
													AND s.ITEMTYPECODE = 'KGF'
													AND s.DECOSUBCODE02 = '$subC1'
													AND s.DECOSUBCODE03 = '$subC2'
													AND s.DECOSUBCODE04 = '$subC3'
								...
								while ($rowdb21R = db2_fetch_assoc($stmt1R)) {
									...
									$sqlDB22R = " SELECT
														...
														LISTAGG (
															DISTINCT TRIM(BALANCE.WAREHOUSELOCATIONCODE),
															', '
													...
													FROM
														(
															...
															WHERE
																...
																AND s.DECOSUBCODE04 = '$subC3'
																AND s.LOGICALWAREHOUSECODE = 'M021'
																AND s.LOTCODE = '$rowdb21R[LOTCODE]'
																AND s.TRANSACTIONNUMBER = '$rowdb21R[TRANSACTIONNUMBER]'
																AND s.TRANSACTIONDATE = '$rowdb21R[TRANSACTIONDATE]'
																AND s.TEMPLATECODE = 'OPN'
																AND a.VALUESTRING = '1'
														) STOCKTRANSACTION
								...
								?>
									<tr>
										...
										<td style="text-align: right"><?php if ($rowdb22R['ROL'] != "") {
																			echo $rowdb22R['ROL'];
																		} else {
																			echo "0";
																		} ?></td>
										<td style="text-align: right"><?php if ($rowdb22R['BERAT'] != "") {
																			echo $rowdb22R['BERAT'];
																		} else {
																			echo "0.00";
																		} ?></td>
								...
								<?php
									...
									$tMRolR += $rowdb21R['JML'];
									$tMKGR += $rowdb21R['KG'];
									$tMRolSR += $rowdb22R['ROL'];
									$tMKGSR += $rowdb22R['BERAT'];
								} ?>
							</tbody>
							<tfoot>
								<tr>
									...
									<td style="text-align: right"><strong><?php echo $tMRolSR; ?></strong></td>
									<td style="text-align: right"><strong><?php echo $tMKGSR; ?></strong></td>
								</tr>
							</tfoot>
						</table>
					</div>
							...
							<tbody>
								...
								?>
									<tr>
										...
										<td style="text-align: right"><?php if ($rowdb21TK['PTG'] == "2") {
																			echo $rtk1 = $rowdb21TK['JML'];
																		} else {
																			echo $rtk1 = "0";
																		} ?></td>
										<td style="text-align: right"><?php if ($rowdb21TK['PTG'] == "2") {
																			echo $tk1 = $rowdb21TK['KG'];
																		} else {
																			echo $tk1 = "0";
																		} ?></td>
										<td style="text-align: right"><?php if ($rowdb21TK['PTG'] == "1") {
																			echo $rptg = $rowdb21TK['JML'];
																		} else {
																			echo $rptg = "0";
																		} ?></td>
										<td style="text-align: right"><?php if ($rowdb21TK['PTG'] == "1") {
																			echo $ptg = $rowdb21TK['KG'];
																		} else {
																			echo $ptg = "0";
																		} ?></td>
									</tr>
							...
							<tbody>
								...
								while ($rowdb23 = db2_fetch_assoc($stmt3)) {
									...
									$sqlDB23B = "SELECT
													...
													WHERE
													STOCKTRANSACTION.LOGICALWAREHOUSECODE = 'M021'
													AND STOCKTRANSACTION.ORDERCODE = '$rowdb23[PROVISIONALCODE]'
													AND STOCKTRANSACTION.ORDERLINE = '$rowdb23[ORDERLINE]'
													AND BALANCE.PROJECTCODE = '$rowdb23[PROJECTCODE]'
													GROUP BY
													BALANCE.LOTCODE";
					...
					<div class="card-body">
						<table id="example4" class="table table-sm table-bordered table-striped" style="font-size: 13px; text-align: center;">
							...
							<tbody>
								...
								$sqlDB23 = " SELECT
													STOCKOUT.TRANSACTIONNUMBER,
													STOCKOUT.ITEMELEMENTCODE
												FROM
													(
														SELECT
															STKKELUAR.ITEMELEMENTCODE,
															STKKELUAR.TRANSACTIONNUMBER
														FROM
															DB2ADMIN.STOCKTRANSACTION STOCKTRANSACTION
															LEFT OUTER JOIN DB2ADMIN.ITXVIEWLAPMASUKGREIGE ITXVIEWLAPMASUKGREIGE ON ITXVIEWLAPMASUKGREIGE.PROVISIONALCODE = STOCKTRANSACTION.ORDERCODE
															AND ITXVIEWLAPMASUKGREIGE.ORDERLINE = STOCKTRANSACTION.ORDERLINE
								...
								while ($rowdb23 = db2_fetch_assoc($stmt3)) {
									$sqlDB24 = "SELECT
													x.ITEMELEMENTCODE,
													y.ELEMENTSCODE,
													x.BASEPRIMARYQUANTITY AS QTY_KG
												FROM
						...
						<table id="example7" class="table table-sm table-bordered table-striped" style="font-size: 13px; text-align: center;">
							<thead>
								...
								<tr>
									<th valign="middle" style="text-align: center">Tanggal</th>
									<th valign="middle" style="text-align: center">Prod. Order</th>
									<th valign="middle" style="text-align: center">Order | Demand | Bruto | Lot | Warna</th>
									<th valign="middle" style="text-align: center">Project</th>
									<th valign="middle" style="text-align: center">Roll</th>
									<th valign="middle" style="text-align: center">Berat/Kg</th>
								</tr>
							...
							<tbody>
								...
								foreach ($grouped as $rowdb23) {
									$sqlDB2PRJ = " SELECT
														...
														LISTAGG (
															DISTINCT TRIM(ORIGDLVSALORDLINESALORDERCODE),
															', '
													...
													FROM
														ITXVIEWHEADERKNTORDER
													WHERE
														PRODUCTIONORDERCODE = '" . $rowdb23[' ORDERCODE '] . "'
													GROUP BY
														PRODUCTIONORDERCODE
													";
									$stmtPRJ   = db2_exec($conn1, $sqlDB2PRJ, array('cursor' => DB2_SCROLLABLE));
									$rowdbPRJ = db2_fetch_assoc($stmtPRJ);
									if ($rowdb23['ORIGDLVSALORDLINESALORDERCODE'] != "") {
										$prjct = $rowdb23['ORIGDLVSALORDLINESALORDERCODE'];
									} else {
										$prjct = substr($rowdbPRJ['ORIGDLVSALORDLINESALORDERCODE'], 0, 10);
									}
									$sqlDB2WRN = " SELECT
														...
														pd.ORIGDLVSALORDERLINEORDERLINE,
														pd.DESCRIPTION,
														a.VALUEDECIMAL AS BRUTOKK
													FROM
														PRODUCTIONDEMANDSTEP p
														LEFT OUTER JOIN PRODUCTIONDEMAND pd ON pd.CODE = p.PRODUCTIONDEMANDCODE
														LEFT OUTER JOIN ADSTORAGE a ON a.UNIQUEID = pd.ABSUNIQUEID
														AND a.NAMENAME = 'BrutoKK'
													...
													WHERE
														--    (pd.PROJECTCODE='$rowdb23[PROJECTCODE]' OR pd.ORIGDLVSALORDLINESALORDERCODE='$prjct')  AND 
														p.PRODUCTIONORDERCODE = '$rowdb23[ORDERCODE]'
													GROUP BY
														ugp.LONGDESCRIPTION,
														p.PRODUCTIONORDERCODE,
														pd.SUBCODE01,
									...
									if ($rowdb23['PROJECTCODE'] != "") {
										...
										$prj = $rowdb23['ORIGDLVSALORDLINESALORDERCODE'];
									} else {
										$prj = $prjct;
									}
									if ($rowdbWRN['PRODUCTIONDEMANDCODE'] != "") {
										$dmnd = $rowdbWRN['PRODUCTIONDEMANDCODE'];
									} else {
										$dmnd = $rowdbPRJ['PRODUCTIONDEMANDCODE'];
									}
									$sqlDB2ORD = "SELECT
														x.ORIGDLVSALORDLINESALORDERCODE,
														x.ORIGDLVSALORDERLINEORDERLINE
													FROM
														DB2ADMIN.PRODUCTIONDEMAND x
													WHERE CODE = '$dmnd'
													";
									$stmtORD   = db2_exec($conn1, $sqlDB2ORD, array('cursor' => DB2_SCROLLABLE));
									$rowdbORD = db2_fetch_assoc($stmtORD);
									$sqlDB2BRTO = " SELECT
														a.VALUEDECIMAL AS BRUTOKG,
														a1.VALUEDECIMAL AS NETTOKG
													FROM
														(
															SELECT
																sol.ABSUNIQUEID
															FROM
																DB2ADMIN.PRODUCTIONDEMAND pd
																LEFT OUTER JOIN DB2ADMIN.SALESORDERLINE sol ON sol.SALESORDERCODE = pd.ORIGDLVSALORDLINESALORDERCODE
																AND sol.ORDERLINE = pd.ORIGDLVSALORDERLINEORDERLINE
															WHERE
																sol.SALESORDERCODE = '" . $rowdbORD[' ORIGDLVSALORDLINESALORDERCODE '] . "'
																AND sol.ORDERLINE = '" . $rowdbORD[' ORIGDLVSALORDERLINEORDERLINE '] . "'
															GROUP BY
																sol.ABSUNIQUEID
														) sol
														LEFT OUTER JOIN DB2ADMIN.ADSTORAGE a ON a.UNIQUEID = sol.ABSUNIQUEID
														AND a.NAMENAME = 'BrutoKG'
														LEFT OUTER JOIN DB2ADMIN.ADSTORAGE a1 ON a1.UNIQUEID = sol.ABSUNIQUEID
														AND a1.NAMENAME = 'NettoKG'
													";
									$stmtBRTO   = db2_exec($conn1, $sqlDB2BRTO, array('cursor' => DB2_SCROLLABLE));
									$rowdbBRTO = db2_fetch_assoc($stmtBRTO);
								?>
									<tr>
										...
										<td style="text-align: left"><?php
																		while ($rowdbWRN = db2_fetch_assoc($stmtWRN)) {
																			echo "<table width='100%'><tr><td>" . trim($rowdbWRN['ORIGDLVSALORDLINESALORDERCODE']) . "-" . trim($rowdbWRN['ORIGDLVSALORDERLINEORDERLINE']) . "</td><td>" . trim($rowdbWRN['PRODUCTIONDEMANDCODE']) . "</td><td>" . round($rowdbWRN['BRUTOKK'], 2) . "</td><td>" . trim($rowdbWRN['DESCRIPTION']) . "</td><td>" . trim($rowdbWRN['WARNA']) . "</td></tr></table>";
																		}
																		?></td>
										...
										<td style="text-align: center"><?php if ($rowdb23['PROJECTCODE'] != "") {
																			echo $rowdb23['PROJECTCODE'];
																		} else if ($rowdb23['ORIGDLVSALORDLINESALORDERCODE'] != "") {
																			echo $rowdb23['ORIGDLVSALORDLINESALORDERCODE'];
																		} else {
																			echo $rowdbPRJ['ORIGDLVSALORDLINESALORDERCODE'];
																		} ?></td>
