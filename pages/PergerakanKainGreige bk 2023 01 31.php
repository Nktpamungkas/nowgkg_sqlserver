...
?>
      ...
      <td style="text-align: right"><?php echo round($rowdb21RP['QTY_KG'],2); ?></td>
      </tr>
	...
	$tMKGRP +=$rowdb21RP['QTY_KG'];	
	    ...
	    <td style="text-align: right"><strong><?php echo number_format(round($tMKGRP,2),2);?></strong></td>
	    </tr>			
		</tfoot>
                </table>
              </div>
...
?>
      ...
      <td style="text-align: right"><?php echo number_format(round($rowdb23In['KG'],2),2); ?></td>
      </tr>
	...
	$tCGKG3In +=$rowdb23In['KG'];				
	    ...
	    <td style="text-align: right"><strong><?php echo number_format(round($tCGKG3In,2),2);?></strong></td>
	    </tr>			
		</tfoot>
                </table>		
					</div> 
...
?>
      ...
      <td style="text-align: right"><?php echo number_format(round($rowdb21TK['KG'],2),2); ?></td>
      </tr>
	...
	$tMKGTK +=$rowdb21TK['KG'];	
	    ...
	    <td style="text-align: right"><strong><?php echo number_format(round($tMKGTK,2),2);?></strong></td>
	    </tr>			
		</tfoot>
                </table>							
		  </div> 
...
?>
	...
	$tKCutH +=$tCH;	
	    ...
	    <td style="text-align: right"><strong><?php echo number_format(round($tCHKG3,2),2); ?></strong></td>
	    <td style="text-align: center">&nbsp;</td>
	    </tr>			
		</tfoot>
                </table>					
...
pd.SUBCODE03,pd.SUBCODE04,pd.SUBCODE05,pd.SUBCODE06,pd.SUBCODE07,pd.SUBCODE08,pd.ITEMTYPEAFICODE  
    ...
    WHERE pd.PROJECTCODE='$rowdb23[PROJECTCODE]' AND p.PRODUCTIONORDERCODE='$rowdb23[ORDERCODE]'
...
WHERE PROJECTCODE ='$rowdb23[PROJECTCODE]' AND ITEMTYPE_DEMAND ='$rowdbWRN[ITEMTYPEAFICODE]' AND 
...
?>
      ...
      <td align="right"><?php echo number_format(round($rowdbBRTO['QTYBRUTO'],2),2); ?></td>
	...
	$tKKG31  +=$rowdb23['QTY_KG'];	
		...
		<?php 
		  //$sisaGreige=(round($tMKG,2)+$tMKGR+$tCGKG3In)-(round($tKKG31,2)+$tKCutS+$tKCutH+$tMKGTK); 
			$sisaGreige=($tMKG + $tMKGR + $tMKGRP) - ($tKKG31 + $tKCutS + $tKCutH); 
		  ?>	
		<div class="row">
			<div class="col-md-4">	
		<div class="card card-danger">
