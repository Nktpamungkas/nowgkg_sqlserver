...
p.SUBCODE04='".trim($rowdb21['DECOSUBCODE04'])."' AND p.PROJECTCODE ='".trim($project)."'
...
SELECT pr.LONGDESCRIPTION,p.PRODUCTIONORDERCODE,pd.SUBCODE01,pd.SUBCODE02,pd.SUBCODE03,
    ...
    AND pr.SUBCODE09 = pd.SUBCODE09
    AND pr.SUBCODE10 = pd.SUBCODE10
WHERE pd.PROJECTCODE ='$project' AND p.PRODUCTIONORDERCODE='$rowdb21[ORDERCODE]'	
...
?>
      ...
      <td style="text-align: center"><?php echo $rowdb24['INTERNALREFERENCE']; ?></td>
