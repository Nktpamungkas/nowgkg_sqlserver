...
<div class="modal-dialog modal-xl">
	<div class="modal-content">
				...
				<table id="lookup1" class="table table-sm table-bordered table-hover table-striped" width="100%" style="font-size: 14px;">
					<thead>
						...
						<tr>
							...
							<th width="16%">
								<div align="center">ELEMENTCODE</div>
							</th>
							<th width="15%">
								<div align="center">KG</div>
							</th>
							<th width="14%">
								<div align="center">LOTCODE</div>
							</th>
							<th>
							...
							<th width="13%">
								<div align="center">ORDERCODE</div>
							</th>
							<th width="13%">
								<div align="center">PROJECTCODE</div>
							</th>
						</tr>
					</thead>
					<tbody>
		...
		LEFT OUTER JOIN (
		SELECT e.WIDTHGROSS AS LEBAR1,a.VALUEDECIMAL AS GSM1,e.ELEMENTCODE  FROM ELEMENTSINSPECTION e 
		LEFT OUTER JOIN ADSTORAGE a ON a.UNIQUEID =e.ABSUNIQUEID AND a.NAMENAME ='GSM')	lg ON lg.ELEMENTCODE=STOCKTRANSACTION.ITEMELEMENTCODE				
	...
	<td align=center>" . round($rD['LEBAR1']) . "</td>
	<td align=center>" . round($rD['GSM1']) . "</td>
