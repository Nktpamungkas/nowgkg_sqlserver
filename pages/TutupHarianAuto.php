...
$no=1;   
$c=0;				  
$sql = mysqli_query($con," SELECT tgl_tutup,sum(rol) as rol,sum(weight) as kg,DATE_FORMAT(now(),'%Y-%m-%d') as tgl FROM tblopname GROUP BY tgl_tutup ORDER BY tgl_tutup LIMIT 30");		  
