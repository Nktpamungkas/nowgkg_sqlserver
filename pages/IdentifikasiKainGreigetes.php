...
FROM
    QUALITYDOCLINE
WHERE
	(QUALITYDOCUMENTHEADERNUMBERID ='35' OR QUALITYDOCUMENTHEADERNUMBERID ='1379') AND
...
?>
      ...
      <td style="text-align: left"><span style="text-align: center"><?php echo round($rowdb26['LEBAR1']); ?></span></td>
      <td style="text-align: left"><span style="text-align: center"><?php echo round($rowdb26['GSM1']); ?></span></td>
