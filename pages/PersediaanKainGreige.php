...
b.WHSLOCATIONWAREHOUSEZONECODE,b.WAREHOUSELOCATIONCODE,prj.PROJECTCODE,prj1.PROJECTCODE,prj2.PRODUCTIONORDERCODE,prj2.ORIGDLVSALORDLINESALORDERCODE ";
  ...
  $sqlDB28 = " SELECT DISTINCT  
                TRIM(p.SUMMARIZEDDESCRIPTION) as SUMMARIZEDDESCRIPTION
                  FROM FULLITEMKEYDECODER p
                    WHERE 
                      p.SUBCODE02   = '$rowdb21[DECOSUBCODE02]' AND
                      p.SUBCODE03   = '$rowdb21[DECOSUBCODE03]' AND 
                      p.SUBCODE04   = '$rowdb21[DECOSUBCODE04]' AND 
                      p.ITEMTYPECODE IN ('KGF', 'FKG') ";
