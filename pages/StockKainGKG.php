...
$c=0;
$QTPR =0;	
$sql = mysqli_query($con," SELECT *,sum(weight) as kgs, sum(rol) as roll FROM tblopname WHERE tgl_tutup='$Awal' GROUP BY no_item, proj_awal ORDER BY id ASC");		  
...
?>
      ...
      <td style="text-align: right"><?php if($r1['KGs']>0){echo $r1['KGs'];}else{echo "0";} ?></td>
      <td style="text-align: left"><?php if($r1['KGs']>0){echo $r1['no_bon'];}else{echo "";} ?></td>
      </tr>				  
<?php	
		$no++;
