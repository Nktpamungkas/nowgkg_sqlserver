...
?>
      ...
      <td style="text-align: center"><?php if(substr($rowdb21['EXTERNALREFERENCE'],0,2)=="00" or substr($rowdb21['EXTERNALREFERENCE'],0,3)=="000"){}else{echo $rowdb21['EXTERNALREFERENCE'];} ?></td>
