...
?>
<?php
    $tanggal1  = isset($_GET['tgl_awal']) ? $_GET['tgl_awal'] : '';
...
?>
<strong>LAPORAN SISA KAIN GREIGE (Stock Mati)</strong><br>
<strong>ORDER/PO YANG TELAH SELSEAI</strong><br>
<strong>BULAN <?php echo $bulanTahun; ?></strong><br>
<strong>
    No Form : FW-19-GKG-07/04
</strong><br>
<strong>
    Halaman :
</strong><br>
...
<table style="width: auto;" border="1">
    ...
    <tr>
    <?php
    $tanggalCetak = date('d-M-y'); // Format: 28-May-25
    ?>
        <td>Tanggal</td>
        <td><?php echo $tanggalCetak; ?></td>
        <td></td>
        <td><?php echo $tanggalCetak; ?></td>
        <td><?php echo $tanggalCetak; ?></td>
    </tr>
