...
?>
      ...
      <td style="text-align: left"><span style="text-align: center">
        <?php if($rowdb26['LEBAR1']!=""){echo round($rowdb26['LEBAR1']);}else{echo round($rowdb27['LEBAR1']);} ?>
      </span></td>
      <td style="text-align: left"><span style="text-align: center">
        <?php if($rowdb26['GSM1']!=""){echo round($rowdb26['GSM1']);}else{echo round($rowdb27['GSM1']);} ?>
      </span></td>
