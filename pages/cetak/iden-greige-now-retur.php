...
ADSTORAGE.VALUESTRING ='1' AND STOCKTRANSACTION.PROJECTCODE='$Project' AND STOCKTRANSACTION.TRANSACTIONNUMBER='$Transaction'
GROUP BY 
STOCKTRANSACTION.TRANSACTIONNUMBER,
STOCKTRANSACTION.TRANSACTIONDATE,
STOCKTRANSACTION.TEMPLATECODE,
...
<body>
  <table width="100%" border="" class="table-list1" style="border-bottom:1px #000000 solid;
	...
	border-top:0px #000000 solid;
	border-left:1px #000000 solid;
	border-right:1px #000000 solid;"><font size="+1">IDENTIFIKASI KAIN GREIGE <br/> NO FORM : FW-20-GKG-20/03</font></td>
    </tr>
  </table>
    ...
    <tbody>
      ...
      <tr>
          ...
          <td align="left" width="75%" style="border-bottom:1px #000000 solid;
            border-top:1px #000000 solid;
            border-left:1px #000000 solid;
            border-right:1px #000000 solid;"><?php echo $rowdb2['JML_ROLL']." Rolls  ".$rowdb2['JML_QTY']." KGs";?></td>
      </tr> 
      <tr>
          <td align="left" width="20%" style="border-bottom:1px #000000 solid;
            border-top:1px #000000 solid;
      ...
      <tr>
         <td valign="top"><table width="100%" border="1" class="table-list1">
            ...
            <tbody>
              ...
              border-top:1px #000000 solid;
              border-left:1px #000000 solid;
              border-right:1px #000000 solid;"><?php echo substr($rowdtl1['ITEMELEMENTCODE'],8,5);?></td>
                <td align="center" style="border-bottom:1px #000000 solid;
              border-top:1px #000000 solid;
              border-left:1px #000000 solid;
         ...
         <td valign="top"><table width="100%" border="1" class="table-list1">
          ...
          <tbody>
            ...
            border-top:1px #000000 solid;
            border-left:1px #000000 solid;
            border-right:1px #000000 solid;"><?php echo substr($rowdtl2['ITEMELEMENTCODE'],8,5);?></td>
              <td align="center" style="border-bottom:1px #000000 solid;
            border-top:1px #000000 solid;
            border-left:1px #000000 solid;
