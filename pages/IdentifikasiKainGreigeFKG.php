...
$c=0;
	...
	ITXVIEWLAPMASUKGREIGE.SUBCODE02,ITXVIEWLAPMASUKGREIGE.SUBCODE03,ITXVIEWLAPMASUKGREIGE.SUBCODE04,
       ...
       ITXVIEWLAPMASUKGREIGE.PROVISIONALCODE,SUM(STOCKTRANSACTION.BASEPRIMARYQUANTITY) AS QTY_KG,
	   SUM(STOCKTRANSACTION.BASESECONDARYQUANTITY) AS BRUTO, COUNT(STOCKTRANSACTION.BASEPRIMARYQUANTITY) AS QTY_ROL,
...
LEFT OUTER JOIN INTERNALDOCUMENTLINE i ON i.INTDOCUMENTPROVISIONALCODE = ITXVIEWLAPMASUKGREIGE.PROVISIONALCODE AND i.ORDERLINE =i.ORDERLINE 
LEFT OUTER JOIN ADSTORAGE a ON a.UNIQUEID = i.ABSUNIQUEID AND a.NAMENAME ='NWarna'
...
GROUP BY ITXVIEWLAPMASUKGREIGE.PROVISIONALCODE, a.VALUESTRING,
...
if (trim($rowdb21['PROVISIONALCOUNTERCODE']) =='I02M50') { $knitt = 'KNITTING ITTI- GREIGE'; } 
		...
		$sqlDB23 = " SELECT x.* FROM DB2ADMIN.ITXVIEWHEADERKNTORDER x
		WHERE PROJECTCODE ='$Project' AND ITEMTYPEAFICODE ='FKG' AND PRODUCTIONORDERCODE ='$rowdb21[EXTERNALREFERENCE]' ";					  
...
FROM BALANCE b  
WHERE b.ITEMTYPECODE ='FKG'  AND b.LOGICALWAREHOUSECODE ='M021' ) AS STKBLANCE ON STKBLANCE.ELEMENTSCODE=STOCKTRANSACTION.ITEMELEMENTCODE
...
WHERE
	...
	QUALITYDOCUMENTITEMTYPEAFICODE ='FKG'
...
WHERE
	...
	QUALITYDOCUMENTITEMTYPEAFICODE ='FKG' AND
