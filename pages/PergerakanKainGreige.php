...
pd.SUBCODE03,pd.SUBCODE04,pd.SUBCODE05,pd.SUBCODE06,pd.SUBCODE07,pd.SUBCODE08,pd.ITEMTYPEAFICODE,pd.PROJECTCODE,pd.ORIGDLVSALORDLINESALORDERCODE,
pd.ORIGDLVSALORDERLINEORDERLINE,pd.DESCRIPTION,a.VALUEDECIMAL AS BRUTOKK  
	FROM PRODUCTIONDEMANDSTEP p
	LEFT OUTER JOIN PRODUCTIONDEMAND pd ON pd.CODE =p.PRODUCTIONDEMANDCODE
	LEFT OUTER JOIN ADSTORAGE a ON a.UNIQUEID =pd.ABSUNIQUEID AND a.NAMENAME ='BrutoKK'
	...
	pd.SUBCODE05,pd.SUBCODE06,pd.SUBCODE07,pd.CODE,
	pd.SUBCODE08,pd.ITEMTYPEAFICODE,pd.PROJECTCODE,pd.ORIGDLVSALORDLINESALORDERCODE,pd.ORIGDLVSALORDERLINEORDERLINE,pd.DESCRIPTION,a.VALUEDECIMAL  
";
