              ...
              <div class="card-body">
                <table id="example1" class="table table-sm table-bordered table-striped" style="font-size: 13px; text-align: center;">
                  ...
                  <tr>
                    ...
                    <th rowspan="2" valign="middle" style="text-align: center">Project Akhir</th>
...
$c=0;
	...
	LISTAGG(DISTINCT  TRIM(ITXVIEWKNTORDER.PRODUCTIONDEMANDCODE),', ') AS PRODUCTIONDEMANDCODE FROM 
...
$sqlDB25 = " SELECT x.PROJECTCODE FROM DB2ADMIN.PRODUCTIONDEMAND x
...
?>
      ...
      <td style="text-align: center"><?php echo $rowdb25['PROJECTCODE']; ?></td>
