              ...
              <div class="card-body">
                <table id="example1" class="table table-sm table-bordered table-striped" style="font-size: 13px; text-align: center;">
                  ...
                  <tr>
                    ...
                    <th rowspan="2" valign="middle" style="text-align: center">Shift</th>
                    <th rowspan="2" valign="middle" style="text-align: center">Op1 Bagi</th>
                    <th rowspan="2" valign="middle" style="text-align: center">Op2 Bagi</th>
                    </tr>
                  <tr>
...
if($rowdb24['PRODUCTIONDEMANDCODE']!=""){$demandn=$rowdb24['PRODUCTIONDEMANDCODE'];}else{$demandn=$rowdb21['PRODUCTIONDEMANDCODE'];}		
$sqlDB2KPI = " SELECT
	a.VALUESTRING AS KD,
	b.VALUESTRING AS NAMA1,
	c.VALUESTRING AS NAMA2
FROM
	PRODUCTIONDEMAND pd  
LEFT OUTER JOIN ADSTORAGE a ON
	a.UNIQUEID = pd.ABSUNIQUEID 
	AND a.NAMENAME = 'BagiKainShift1'
LEFT OUTER JOIN ADSTORAGE b ON
	b.UNIQUEID = pd.ABSUNIQUEID 
	AND b.NAMENAME = 'BagiKainOperator1'
LEFT OUTER JOIN ADSTORAGE c ON
	c.UNIQUEID = pd.ABSUNIQUEID 
	AND c.NAMENAME = 'BagiKainOperator2'	
WHERE
	pd.CODE ='$demandn'
...
?>
      ...
      <td><?php echo $rKPI['NAMA1']; ?></td>
      <td><?php echo $rKPI['NAMA2']; ?></td>
      </tr>
	...
	<tr>
		...
		<div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Detail Laporan Harian Permintaan Potong dan Tarikan Kain Greige</h3>
...
WHERE s.ITEMTYPECODE='KGF' AND s.LOGICALWAREHOUSECODE ='M021' AND (a.VALUESTRING ='1' OR a.VALUESTRING ='2') AND
...
LEFT OUTER JOIN ADSTORAGE a ON a.UNIQUEID = s.ABSUNIQUEID AND a.NAMENAME = 'StatusPotong'
LEFT OUTER JOIN ADSTORAGE a1 ON a1.UNIQUEID = s.ABSUNIQUEID AND a1.NAMENAME = 'NoteMintaPotong'
WHERE s.ITEMTYPECODE='KGF' AND s.LOGICALWAREHOUSECODE ='M021' AND NOT a.VALUESTRING ='1' AND NOT a.VALUESTRING ='2' AND
s.TEMPLATECODE = '098' AND s.TRANSACTIONDATE BETWEEN '$Awal' AND '$Akhir' 
GROUP BY s.TRANSACTIONDATE, s.DECOSUBCODE02, s.DECOSUBCODE03, s.DECOSUBCODE04, 
s.LOTCODE,s.CREATIONUSER,a.VALUESTRING, a1.VALUESTRING, s.PROJECTCODE ";
	$stmt1   = db2_exec($conn1,$sqlDB21, array('cursor'=>DB2_SCROLLABLE));
